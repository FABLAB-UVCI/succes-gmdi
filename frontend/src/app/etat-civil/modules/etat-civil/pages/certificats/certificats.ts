...
export async function genererCertificatPDF(type: string, data: {
  ...
  profession?: string; dateDelivrance?: string;
    ...
    if (type === 'Célibat') {
      ...
      introText = `L'Officier de l'État Civil soussigné certifie qu'il résulte des registres de l'état civil qu'à ce jour, ${nomComplet || '.........................'} n'a contracté aucun mariage.`;
      detailRows = `
      ...
      introText = `L'Officier de l'État Civil soussigné certifie qu'il résulte des vérifications effectuées que ${nomComplet || '.........................'} réside effectivement à l'adresse mentionnée ci-dessous.`;
      detailRows = `
                    <tr><td class="label-cell">Nom</td><td class="separator-cell">:</td><td class="value-cell">${data.nom}</td></tr>
                    <tr><td class="label-cell">Prénoms</td><td class="separator-cell">:</td><td class="value-cell">${data.prenom}</td></tr>
      ...
      subtitle = "(Article 100 du Code des Personnes et de la Famille)";
      introText = `L'Officier de l'État Civil soussigné certifie qu'il résulte des vérifications effectuées que ${nomComplet || '.........................'} est en vie à la date de délivrance du présent certificat.`;
      detailRows = `
                    <tr><td class="label-cell">Nom</td><td class="separator-cell">:</td><td class="value-cell">${data.nom}</td></tr>
                    <tr><td class="label-cell">Prénoms</td><td class="separator-cell">:</td><td class="value-cell">${data.prenom}</td></tr>
                    <tr><td class="label-cell">Date de naissance</td><td class="separator-cell">:</td><td class="value-cell mixed">${formatDateFr(data.dob)}</td></tr>`;
...
<body>
    <div class="document-container">
        ...
        <div class="content-container">
            ...
            <div class="left-data-column">
                ...
                <table class="data-table">
                    ...
                    <tr><td class="label-cell">Date de délivrance</td><td class="separator-cell">:</td><td class="value-cell mixed">${data.dateDelivrance || today}</td></tr>
                    <tr><td class="label-cell">N° du certificat</td><td class="separator-cell">:</td><td class="value-cell mixed">${data.numero}</td></tr>
        ...
        <div class="footer-legal-notice">
            Le présent certificat est délivré par système électronique sécurisé et comporte un timbre numérique officiel. Il a la même valeur probante que l'original conformément aux dispositions de l'ordonnance n° 2019-312 du 20 mars 2019 relative à la dématérialisation des actes et documents administratifs.

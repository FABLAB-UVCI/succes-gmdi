...
<head>
  ...
  <title>Jugement Supplétif</title>
  <style>
...
<body>
  ...
  <div class="document-container">
    ...
    <div class="title-section">
      <h1 class="main-title">TRANSCRIPTION DE JUGEMENT SUPPLÉTIF</h1>
      <div class="subtitle">(Article 108 du Code des Personnes et de la Famille)</div>
    </div>

    <div class="intro-text">
      L'Officier de l'État Civil soussigné certifie qu'il résulte du jugement supplétif rendu par le tribunal ci-dessous mentionné, tenant lieu d'acte de naissance, que l'enfant désigné ci-après est né(e) dans les conditions relatées.
    </div>
      ...
      <tr>
        <td class="left-data-column">
          ...
          <table class="data-table">
            <tr><td class="label-cell">Nom et prénoms</td><td class="separator-cell">:</td><td class="value-cell">{{ $don['nom'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Date de naissance</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['date_naissance'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Lieu de naissance</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['lieu'] ?? '.......................' }}</td></tr>
          </table>

          <div class="section-title">Jugement</div>
          <table class="data-table">
    ...
    <div class="footer-legal-notice">
      Le présent extrait est délivré par système électronique sécurisé et comporte un timbre numérique officiel. Il a la même valeur probante que l'original conformément aux dispositions de l'ordonnance n° 2019-312 du 20 mars 2019.

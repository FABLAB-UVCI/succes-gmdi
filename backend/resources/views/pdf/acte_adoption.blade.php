...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .main-title { color: #1e5c33; font-size: 22px; font-weight: bold; letter-spacing: 1px; margin: 0 0 5px 0; }
...
<body>
  @php $don = $demarche->donnees ?? []; @endphp
  <div class="document-container">
    ...
    <div class="title-section">
      ...
      <div class="subtitle">(Article 108 du Code des Personnes et de la Famille)</div>
    </div>

    <div class="intro-text">
      L'Officier de l'État Civil soussigné certifie qu'il résulte des éléments du jugement d'adoption ci-dessous mentionné, que l'enfant désigné a été légalement adopté(e) par les personnes ci-après identifiées comme parents adoptifs.
    </div>

    <table class="content-container">
      <tr>
        <td class="left-data-column">
          <div class="section-title">Enfant adopté</div>
          <table class="data-table">
            <tr><td class="label-cell">Nom et prénoms</td><td class="separator-cell">:</td><td class="value-cell">{{ $don['enfant_nom'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Date de naissance</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['enfant_date_naissance'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Lieu de naissance</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['enfant_lieu_naissance'] ?? '.......................' }}</td></tr>
          </table>

          <div class="section-title">Parents adoptifs</div>
          <table class="data-table">
            <tr><td class="label-cell">Père adoptant</td><td class="separator-cell">:</td><td class="value-cell">{{ $don['pere_nom'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Profession</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['pere_profession'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Nationalité</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['pere_nationalite'] ?? 'Ivoirienne' }}</td></tr>
            <tr><td class="label-cell">Mère adoptante</td><td class="separator-cell">:</td><td class="value-cell">{{ $don['mere_nom'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Profession</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['mere_profession'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Nationalité</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['mere_nationalite'] ?? 'Ivoirienne' }}</td></tr>
          </table>

          <div class="section-title">Jugement d'adoption</div>
          <table class="data-table">
            <tr><td class="label-cell">Tribunal</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['tribunal'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Date du jugement</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['date_jugement'] ?? '.......................' }}</td></tr>
            <tr><td class="label-cell">Type d'adoption</td><td class="separator-cell">:</td><td class="value-cell mixed">{{ $don['type_adoption'] ?? 'Pleine' }}</td></tr>
    ...
    <table style="width:100%; margin-top:20px;">
      <tr>
        ...
        <td style="width:50%; text-align:center; font-size:12px;">
          <div>Fait à Cocody, le {{ date('d/m/Y') }}</div>

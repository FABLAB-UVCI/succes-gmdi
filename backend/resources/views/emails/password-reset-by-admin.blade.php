...
<head>
  ...
  <title>Votre mot de passe E-Mairie a été réinitialisé</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div class="body">
      ...
      <p class="text">
        Votre administrateur vient de réinitialiser le mot de passe de votre compte <strong>E-Mairie</strong>.
        Voici votre nouveau mot de passe de connexion :
      </p>

      <div class="creds">
        <div class="creds-row"><span class="creds-label">Email</span><span class="creds-value">{{ $user->email }}</span></div>
        <div class="creds-row"><span class="creds-label">Nouveau mot de passe</span><span class="creds-value">{{ $password }}</span></div>
      </div>
      ...
      <div class="warning">
        ⚠️ <strong>Important :</strong> Vos anciennes sessions ont été déconnectées. Utilisez le lien
        <em>« Accès Professionnel »</em> sur la page d'accueil pour vous reconnecter, et conservez ce mot de passe en lieu sûr.
      </div>
    </div>
